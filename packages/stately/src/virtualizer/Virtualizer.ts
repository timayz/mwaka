...
//     let view = reusable.length > 0 ? reusable.pop() : new ReusableView<T, V>(this);
...
//       if (finalAnchor) {
//         let adjustment =
//           finalAnchor.rect[scrollAnchor.corner].y - contentOffset.y - scrollAnchor.offset;
...
//       this._transaction && (toAdd.size > 0 || toRemove.size > 0 || this._hasLayoutUpdates());
//     if (hasLayoutUpdates) {
...
//     let buildTree = (parent: ReusableView<T, V>, views: ReusableView<T, V>[]): W[] =>
//       views.map((view) => {
//         let children = viewsByParentKey.get(view.layoutInfo.key);
//         return this.delegate.renderWrapper(parent, view, children, (childViews) =>
//           buildTree(view, childViews),
//         );
//       });
...
//     this._scrollAnimation = tween(this.visibleRect, offset, duration, easeOut, (offset) => {
//       this._setContentOffset(offset);
//     });
