...
export interface AriaColorFieldProps
  extends ColorFieldProps,
    ...
    Omit<
      TextInputDOMProps,
      "minLength" | "maxLength" | "pattern" | "type" | "inputMode" | "autoComplete"
    >,
    AriaValidationProps {}
...
export interface ColorWheelProps extends ValueBase<string | Color, Color> {
...
export interface ColorSliderProps
  extends Omit<SliderProps<string | Color>, "minValue" | "maxValue" | "step" | "pageSize"> {
  /** The color channel that the slider manipulates. */
  channel: ColorChannel;
  /** Handler that is called when the value changes, as the user drags. */
  onChange?: (value: string | Color) => void;
  /** Handler that is called when the user stops dragging. */
  onChangeEnd?: (value: string | Color) => void;
}
...
export interface ColorAreaProps extends ValueBase<string | Color, Color> {
