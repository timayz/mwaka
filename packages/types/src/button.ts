...
export interface AriaButtonElementTypeProps<T extends JSX.Element = "button"> {
  /**
   * The HTML element or React element used to render the button, e.g. 'div', 'a', or `RouterLink`.
   * @default 'button'
   */
  elementType?: T | Component<unknown>;
}

export interface LinkButtonProps extends AriaButtonElementTypeProps {
...
export interface AriaToggleButtonProps<T extends JSX.Element = "button">
