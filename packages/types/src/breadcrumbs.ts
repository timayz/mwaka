...
import { AriaLabelingProps, DOMProps, PressEvents, StyleProps, Key } from "./shared";
...
export interface SpectrumBreadcrumbsProps extends AriaBreadcrumbsProps, StyleProps {
  /**
