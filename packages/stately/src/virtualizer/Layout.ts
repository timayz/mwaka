...
export abstract class Layout<T extends object> {
  ...
  virtualizer?: Virtualizer<T, unknown, unknown> | null;
  ...
  validate(invalidationContext: InvalidationContext<T, unknown>) {} // eslint-disable-line @typescript-eslint/no-unused-vars
