...
export type ItemElement = JSX.Element;
export type ItemRenderer<T> = (item: T) => ItemElement;
...
export interface SectionProps<T> {
  ...
  children: ItemElement | ItemElement[] | ItemRenderer<T>;
...
export type CollectionElement = SectionElement | ItemElement;
export type CollectionChildren<T> =
  | CollectionElement
  | CollectionElement[]
  | ((item: T) => CollectionElement);
...
export interface Expandable {
  ...
  onExpandedChange?: (keys: Set<Key>) => unknown;
}
...
export interface Sortable {
  ...
  onSortChange?: (descriptor: SortDescriptor) => unknown;
}
