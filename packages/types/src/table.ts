...
import { GridCollection, GridNode } from "./grid";
import { JSX } from "solid-js";

export interface TableProps extends MultipleSelection, Sortable {
...
export interface TableHeaderProps<T> {
  ...
  children: ColumnElement | ColumnElement[] | ColumnRenderer<T>;
}

type ColumnElement = JSX.Element;
type ColumnRenderer<T> = (item: T) => ColumnElement;
export interface ColumnProps<T> {
  ...
  children: JSX.Element | ColumnElement | ColumnElement[];
...
export type CellElement = JSX.Element;
